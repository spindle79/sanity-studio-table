...
export interface VisibleColumn<TableData = unknown>
  extends BaseColumn<TableData> {
  hidden?: false;
  cell: (props: {
...
export type Column<TableData = unknown> =
  | HiddenColumn<TableData>
  | VisibleColumn<TableData>;
